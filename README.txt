...
The objective is to minimize computation and efficiently re-compute the cost of the MST.


How to run the code: 
run the runTest.sh file in terminal, the output files can be found in results folder
The .py file is under src directory.
Input graphs are under data directory
Outputs are under results directory
